    ...
    def decorator(original_func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if device.type == "cuda" and mixed_precision:
                ...
                total_elements = sum([torch.prod(torch.tensor(arg.shape)) for arg in args if torch.is_tensor(arg)])
            ...
            try:
                ...
                raise RuntimeError(f"Error during function execution on {backend} backend: {str(e)}")
